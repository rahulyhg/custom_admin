...
class common_model extends MY_Model{
		...
		public function getUserData($data){
			...
			team_lead,HRM,hr,branch,data_allocate,recruitment,tele,tele_group,tele_lead,tele_lead_group,customer_service,sales_grp_lead,sales_grp,data_entry,data_entry_team,active,group_no FROM users WHERE username=?',array($data));
